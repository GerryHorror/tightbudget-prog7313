 ...
 * This class provides methods to create various drawable shapes such as circles,
 * rounded rectangles, and progress bars. It also provides colour mappings for
 * categories, delegating to IconProvider for consistency where appropriate.
 *
 * This class was generated by ChatGPT and has been modified to fit the application's needs.
 */
